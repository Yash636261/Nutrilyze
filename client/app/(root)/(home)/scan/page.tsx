...
const VideoCapture = dynamic(() => import("@/components/shared/VideoCapture/VideoCapture"), {
  ssr: false,
});
const ImageCapture = dynamic(() => import("@/components/shared/ImageCapture/ImageCapture"), {
  ssr: false,
});
